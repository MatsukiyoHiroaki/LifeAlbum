...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'test/components/initial/initial.spec.js',
      'test/components/login/login.spec.js',
      'test/components/menu/menu.spec.js',
      'test/components/slideshow/slideshow.spec.js',
      'test/components/watchmenu/watchmenu.spec.js',
      'test/main.spec.js',
